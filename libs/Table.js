...
exports.default = {
  ...
  methods: {
    scrollHandle: function scrollHandle(e) {
      var dmHead = e.target.querySelector('thead');

      this.scrollTop = e.target.scrollTop;
      dmHead.style.transform = 'translateY(' + e.target.scrollTop + 'px)';
    },
    setOrder: function setOrder(arr, orderBy) {
      if (this.order) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue__ = __webpack_require__(281);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_93f73ca0_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__ = __webpack_require__(347);
...
var update = add("f95b8326", content, false, {});
...
// module
exports.push([module.i, "\n@charset \"UTF-8\";\n.wrap-table {\n  position: relative;\n  width: 100%;\n  height: 100%;\n  font-size: 12px;\n  overflow: auto;\n}\n.wrap-table table {\n    width: 100%;\n    table-layout: fixed;\n    word-wrap: break-word;\n}\n.wrap-table table thead.fix {\n      box-shadow: 0 1px 1px #e3e3e3;\n}\n.wrap-table table tbody > tr:nth-child(odd) {\n      background-color: #f7f7f7;\n}\n.wrap-table table thead > tr, .wrap-table table tbody > tr:nth-child(even) {\n      background-color: #fff;\n}\n.wrap-table table tbody > tr:hover {\n      background-color: #eee;\n}\n.wrap-table table td {\n      padding-left: 10px;\n      padding-top: 5px;\n      padding-bottom: 5px;\n      height: 32px;\n      border-style: solid;\n      border-width: 0;\n      border-color: transparent;\n      border-collapse: collapse;\n}\n.wrap-table table td .button {\n        position: unset;\n}\n.wrap-table.order table thead td:not(.no-order) {\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n  cursor: pointer;\n}\n.wrap-table.order table thead td:not(.no-order):hover:after {\n  content: \" \\2191\\2193\";\n}\n", ""]);
...
var render = function() {
  ...
  return _c(
    "vperfect-scrollbar",
    {
      ...
      class: { order: _vm.order },
      attrs: { settings: _vm.settings }
    },
    [
      _c("table", [
        _c("thead", { class: { fix: _vm.scrollTop > 0 } }, [_vm._t("head")], 2),
        _c(
          "tbody",
          [
            _vm._l(_vm.data, function(item, index) {
              return _vm._t("body", null, { item: item, index: index })
            })
          ],
          2
        )
