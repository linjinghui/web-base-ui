(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ComponentBaseUI"] = factory(require("Vue"));
	else
		root["ComponentBaseUI"] = factory(root["Vue"]);
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_305__) {
...
var _vue = __webpack_require__(305);
...
var _main5 = __webpack_require__(26);
...
exports.default = {
  ...
  props: {
    ...
    // 空列表展示图片
    empty: {
      default: __webpack_require__(308)
    },
    placeholder: {
      default: '请输入关键字查询'
    },
  ...
  methods: {
    ...
    clkSearch: function clkSearch(callback, from) {
      var _this = this;
    ...
    toggleResult: function toggleResult(data) {
      ...
      var index = this.results.indexOf(_data);
    ...
    // 单选结果
    toggleOneResult: function toggleOneResult(data) {
      var _this = this;
      var checked = data.checked;
      var _data = JSON.stringify(data);
      ...
      if (checked && index < 0) {
        ...
        var _index = this.results.length - this.maxCount;

        if (_index > 0) {
          this.results.splice(0, _index);
          var delArr = this.resultSources.splice(0, _index);
    ...
    clkDelItem: function clkDelItem(index) {
      var itemSource = this.resultSources[index];
    ...
    clkClearTreeItem: function clkClearTreeItem() {
      var _this2 = this;
    ...
    // 用户自定义结果集
    emitResultEvent: function emitResultEvent(data) {
    ...
    utlRemoveCustChart: function utlRemoveCustChart(str) {
...
exports.default = {
      ...
      handler: function handler(val) {
        if (this.multiple && typeof val !== 'undefined') {
          if (!val) {
            ...
            var str = JSON.stringify(this.pdata.children);
            // 已被选中的子节点数量，含所有子节点
            var trueLength = str.match(/"checked":true/g).length;
            // 子节点数量，含所有子节点
            var subLength = str.match(/"name"/g).length;
  ...
  methods: {
    // 行点击 
    clkLi: function clkLi() {
      var hasChildren = this.data.children && this.data.children.length > 0;
    ...
    // 开关子节点
    clkToggle: function clkToggle(info) {
    ...
    clkCheck: function clkCheck(info) {
      // let _this = this;
      var str = JSON.stringify(info.children);
      // 剩余可选中的节点数量
      var sy = this.maxCount - this.checkedCount;
      ...
      if (info.checked && info.children && info.children.length > sy) {
        ...
        // });
        // 方式二：循环
        var darrs = JSON.parse(str);
        var returnType = this.returnType;
        var dp = function dp(arr) {
          for (var i = 0; i < arr.length; i++) {
            if (sy < -1) {
              break;
            }
    ...
    evntInitResult: function evntInitResult(data) {
      // 标注已接收到
      window.initResult = 'received';
      var str = JSON.stringify(data);
      var id = this.data.id;
      var regstr = '"id":' + (typeof id === 'string' ? '"' + id + '"' : id);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_18776a09_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_main_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5fad9f6d_hasScoped_true_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_main_vue__ = __webpack_require__(309);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
function injectStyle (context) {
  if (disposed) return
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_list_vue__ = __webpack_require__(120);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_9f39605c_hasScoped_false_optionsId_0_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_list_vue__ = __webpack_require__(307);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__node_modules_vue_loader_lib_runtime_component_normalizer__ = __webpack_require__(2);
var disposed = false
/* script */
  ...
  return _c(
    ...
    [
      _c(
        "span",
        {
          staticClass: "wrap-arrow",
          on: {
            click: function($event) {
              $event.stopPropagation()
              return _vm.clkToggle(_vm.data)
            }
          }
        },
        [
          _vm.data.children
            ? _c("i", { staticClass: "cicon-triangle" })
            : _vm._e()
        ]
      ),
      _vm.multiple &&
      ...
      _vm.data.img
        ...
        : _vm._e(),
      _c("span", { staticClass: "wrap-text" }, [_vm._v(_vm._s(_vm.data.name))]),
      _vm.data.children
        ? _c(
            "ul",
            {
            ...
            _vm._l(_vm.data.children, function(itemData, index) {
              return _c("item", {
                ...
                attrs: {
                  ...
                  checkedCount: _vm.checkedCount,
                  returnType: _vm.returnType,
...
module.exports = "data:image/png;base64,"
          ...
          [
                  ...
                  _c(
                      ...
                      directives: [
                        {
                          name: "show",
                          rawName: "v-show",
                          value: _vm.showTree || _vm.showSearchData,
                          expression: "showTree||showSearchData"
                        }
                      ],
                    ...
                    [
                      _c(
                        ...
                        [
                          _vm.treeTitle
                            ? _c("li", { staticClass: "tree-title" }, [
                                _vm._v(_vm._s(_vm.treeTitle))
                              ])
                            : _vm._e(),
                          _vm._l(_vm.treeData, function(itemData, index) {
                            return _c("cmp-li", {
                              key: itemData.id + "_" + index,
                              attrs: {
                                data: itemData,
                                maxCount: _vm.maxCount,
                                checkedCount: _vm.results.length,
                                returnType: _vm.returnType,
                                checkType: _vm.checkType,
                                multiple: _vm.multiple
                              }
                          ...
                          directives: [
                            {
                              name: "show",
                              rawName: "v-show",
                              value: _vm.showSearchData,
                              expression: "showSearchData"
                            }
                          ],
                          staticClass: "wrap-seach"
                        },
                        _vm._l(_vm.searchData, function(itemData, index) {
                          return _c("cmp-li", {
                            key: itemData.id + "_" + index + "_shd",
                            attrs: {
                              data: itemData,
                              maxCount: _vm.maxCount,
                              checkedCount: _vm.results.length,
                    ...
                    [
                      _c(
                        ...
                        _vm._l(_vm.results, function(item, index) {
                          return _c(
                            "li",
                            { key: JSON.parse(item).id + "_" + index + "_rst" },
                            [
                              JSON.parse(item).img
                                ? _c("img", {
                                    attrs: { src: JSON.parse(item).img }
                                  })
                                : _vm._e(),
                              _c("span", [
                                _vm._v(_vm._s(JSON.parse(item).name))
                              ]),
                              _c("i", {
                                staticClass: "cicon-cross-chr",
                                on: {
            ...
            _c(
              ...
              [
                _c(
                  "cmp-button",
                  { staticClass: "confirm", on: { click: _vm.clkConfirm } },
                  [_vm._v("确认")]
                ),
                _c(
                  "cmp-button",
...
// module
exports.push([module.i, "\n.checkbox[data-v-18776a09] {\n  display: inline-block;\n  margin-right: 10px;\n  -webkit-user-select: none;\n     -moz-user-select: none;\n      -ms-user-select: none;\n          user-select: none;\n}\n.checkbox > i[data-v-18776a09] {\n    margin-right: 6px;\n    border-radius: 2px;\n    font-size: 15px;\n    border-color: #dcdfe6;\n    background-color: #fff;\n    vertical-align: -3px;\n}\n.checkbox > i.cicon-tick-cbdr[data-v-18776a09]:before, .checkbox > i.cicon-tick-cbdr[data-v-18776a09]:after {\n    border-color: #fff;\n}\n.checkbox[data-v-18776a09]:not([disabled]) {\n  cursor: pointer;\n}\n.checkbox:not([disabled]):hover > i.cicon-tick-cbdr-cemt[data-v-18776a09] {\n  border-color: #ccc;\n}\n", ""]);
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("i", {
        class: {
          "cicon-tick-cbdr": _vm._select,
          "cicon-tick-cbdr-cemt": !_vm._select
        },
        style: _vm._select ? _vm._style : ""
      }),
      _vm._t("default")
    ],
    2
